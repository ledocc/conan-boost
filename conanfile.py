...
class BoostConan(ConanFile):
    ...
    def source(self):
        ...
        for patch in ["python_base_prefix.patch",
    ...
    def build(self):
        ...
        try:
            filename=os.path.join( self.build_folder, "boost", "bin.v2", "config.log")
            print("********************************************************************************")
            print("********************************************************************************")
            print(filename)
            ...
            sys.stderr.write(os.path.basename(sys.argv[0]) + ": " + filename + ": " + _err.strerror + "\n")
