    ...
    if os.getenv("HEADER_ONLY"):
        ...
        if platform.system() == "Windows":
            ...
            for settings, options, env_vars, build_requires in builder.builds:
                ...
                if ( ( settings["compiler"] == "Visual Studio" ) and ( int(settings["compiler.version"]) >= 14 ) ):
        ...
        if platform.system() == "Linux":
            ...
            for settings, options, env_vars, build_requires in builder.builds:
                ...
                if ( settings["compiler"] == "gcc" ) and ( settings["compiler.libcxx"] == "libstdc++11" ) :
                    options_use_icu = options.copy()
                    options_use_icu["boost:use_icu"] = True
                    filtered_builds.append([settings, options_use_icu, env_vars, build_requires])
        ...
        if platform.system() == "Darwin":
            ...
            for settings, options, env_vars, build_requires in builder.builds:
                ...
                settings_cppstd11 = settings.copy()
                settings_cppstd11["cppstd"] = 11
                options_use_icu = options.copy()
                options_use_icu["boost:use_icu"] = True
                filtered_builds.append([settings_cppstd11, options_use_icu, env_vars, build_requires])
